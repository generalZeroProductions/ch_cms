...
<div class="card-body" style="height:120px !important; padding:0px !important">
        ...
        <div class = "row ">
            ...
            <div class = "toggle" style = "margin-left:20px;">
                <div class="custom-control custom-switch" name="use_logo">
                    <input type="checkbox" class="custom-control-input" id="logoToggle" <?php echo $showLogo ? 'checked' : ''; ?> name="use_logo">
    ...
    <div class = "title-col" style = "margin-left:12px;">
        <div class="custom-control custom-switch" name = "use_title">
            <input type="checkbox" class="custom-control-input" id="title_Toggle" <?php echo $showTitle ? 'checked' : ''; ?> name = "use_title">
